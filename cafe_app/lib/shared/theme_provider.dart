...
class ThemeProvider with ChangeNotifier {
  ...
  ThemeData themeData() {
    return ThemeData(
      primaryTextTheme: GoogleFonts.playTextTheme(),
      textTheme: GoogleFonts
          .playTextTheme(), //montserrat, exo, exo2, play, aldrich - hranate
      visualDensity: VisualDensity.adaptivePlatformDensity,
      primarySwatch: isLightTheme ? Colors.grey : Colors.grey,
      primaryColor:
          isLightTheme ? Colors.white : Color(0xFF1E1F28), //Color(0xFF1E1F28),
      brightness: isLightTheme ? Brightness.light : Brightness.dark,
      backgroundColor: isLightTheme
          ? Color(0xFFFFFFFF)
          : Color(0x4F26242e), //Color(0xFF26242e),
  ...
  ThemeColor themeMode() {
    return ThemeColor(
      ...
      toggleBackgroundColor:
          isLightTheme ? Color(0xFFFFFFFF) : Color(0xFF222029),
      shadow: [
        if (isLightTheme)
          BoxShadow(
