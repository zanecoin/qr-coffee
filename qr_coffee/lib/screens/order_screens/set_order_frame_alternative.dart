...
//       if (item.type == 'drink' && drink) {
//         result.add(item);
//       }
//       if (item.type == 'food' && !drink) {
//         result.add(item);
//       }
//     }
//     return result;
...
//             child: GridView(
//               children: _filter(items)
//                   .map((item) =>
//                       CoffeeKindTile(coffee: item, callback: appendItem))
//                   .toList(),
...
//       style: customButtonStyle(color: _buttonColor(drink)),
//       child: Text(
//         CzechStrings.drink,
