...
//   Future updateCoffeeData(String uid, int count) async {
//     return await itemCollection.doc(uid).update({'count': count});
//   }

//   // items from snapshot
//   List<Product> _itemsFromSnapshot(QuerySnapshot snapshot) {
//     return snapshot.docs.map((doc) {
//       return Product(
//         name: (doc.data() as dynamic)['name'],
//         price: (doc.data() as dynamic)['price'],
...
//   // get item doc stream
//   Stream<List<Product>> get coffeeList {
...
//   Future updateShopData(bool active) async {
//     return await shopCollection.doc(uid).update({'active': active});
//   }

//   // places from snapshot
//   List<Shop> _placesFromSnapshot(QuerySnapshot snapshot) {
//     return snapshot.docs.map((doc) {
//       return Place(
//         uid: (doc.data() as dynamic)['uid'],
...
//     return shopCollection.snapshots().map(_placesFromSnapshot);
//   }
