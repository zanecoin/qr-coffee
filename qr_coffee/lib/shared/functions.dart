...
List<dynamic> getRemainingTime(
    Order order, String time, ThemeProvider themeProvider, bool colorful) {
  ...
  if (difference > -3000) {
    ...
    if (order.status == OrderStatus.withdraw && colorful) {
      if (themeProvider.isLightMode()) {
        color = Color.fromARGB(255, 148, 101, 0);
      } else {
        color = Color.fromARGB(255, 60, 60, 70);
      }
    } else {
